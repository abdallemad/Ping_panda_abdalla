    ...
    <section className="relative py-24 sm:py-32 bg-brand-25">
      <div className="max-width-wrapper flex flex-col items-center gap-16 sm:gap-20">
        <div>
          ...
          <h1 className="main-heading">Stay ahead with real-time insights</h1>
        </div>
        {/* GRID */}
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)-1px))] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10 ">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  Get notified about critical events them moment they happen, no
          ...
          <div className="relative max-lg:row-start-1">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-t-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  From new user sing ups, to successful payment pingpanda notify
                  you for all critical event in you SaaS.
                </p>
              </div>
