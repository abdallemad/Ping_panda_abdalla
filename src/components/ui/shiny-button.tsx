...
function ShinyButton({ className, children, href, ...props }: Props) {
  return (
    <Link
      href={href || "#"}
      className={cn(
    ...
    >
      ...
      <div  className="ease-[cubic-bezier(0.90,1,0.22,1)] absolute -left-[75px] -top-[50px] -z-10 h-[155px] w-8 rotate-[35deg] bg-white opacity-20 transition-all duration-500 group-hover:left-[150%]"/>
    </Link>
  );
}
